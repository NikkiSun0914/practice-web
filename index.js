...
function showMeme() {
  ...
  const container = document.querySelector(".meme_content");
...
function showJoke() {
  ...
  clearAll();
  document.querySelector(".joke_content").appendChild(newP);
}
...
function showQuote() {
  ...
  clearAll();
  const container = document.querySelector(".quote_content");
...
function showRiddle() {
  ...
  answerElem.setAttribute("id", "riddle_answer");
